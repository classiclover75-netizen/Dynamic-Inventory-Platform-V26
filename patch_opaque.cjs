...
const searchTd = `<td className={getBodyCls('__range_sum', "p-0 border bg-blue-50/30 text-blue-700 align-top")} style={getBodySty('__range_sum')}>
                    {renderMultiSourceCell(JSON.stringify(getRowSumBreakdown(row)), 'bg-blue-50/30', 'text-blue-700', 'border-blue-200', true, true)}
                  </td>`;
const replaceTd = `<td className={getBodyCls('__range_sum', "p-0 border bg-blue-50 text-blue-700 align-top")} style={getBodySty('__range_sum')}>
